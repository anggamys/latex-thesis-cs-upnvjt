...
Template dapat menampilkan tabel yang diisi dari berkas CSV. Simpan data di folder \texttt{figures/} atau \texttt{references/} lalu gunakan paket \texttt{csvsimple}.
