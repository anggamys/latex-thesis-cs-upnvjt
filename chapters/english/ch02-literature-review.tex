...
The template can display tables populated from CSV files. Store the data in the \texttt{figures/} or \texttt{references/} folder and use the \texttt{csvsimple} package.
