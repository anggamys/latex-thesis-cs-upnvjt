...
\newif\iffullthesis
\ifthenelse{\equal{\ThesisStage}{praskripsi}}{\fullthesisfalse}{\fullthesistrue}
...
% Document labels
% Stage-aware label: praskripsi -> "PRA-SKRIPSI", skripsi -> "SKRIPSI"
\newcommand{\ThesisStageLabelID}{\iffullthesis \DocTypeNameID\else PRA-\DocTypeNameID\fi}
\newcommand{\ThesisStageLabelEN}{\iffullthesis \DocTypeNameEN\else PRE-\DocTypeNameEN\fi}
\newcommand{\ThesisStageLabel}{\Lang{\ThesisStageLabelID}{\ThesisStageLabelEN}}
\newcommand{\DocTypeLabel}{\ThesisStageLabel}
