...
% Stage: praskripsi (seminar proposal) atau skripsi (seminar hasil/sidang)
% praskripsi -> cover "PRA-SKRIPSI", tanpa abstrak, hanya bab 1-3
% skripsi    -> cover "SKRIPSI", full abstract, bab 1-5
\newcommand{\ThesisStage}{skripsi}
